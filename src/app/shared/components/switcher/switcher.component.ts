...
export class SwitcherComponent {
  ...
  updatemenuType(navigationStyles: string) {
    ...
    if (navigationStyles == 'horizontal') {
      ...
      this.appStateService.updateState({ navigationStyles,menuStyles:'menu-click',menuColor:'light', layoutStyles: '' });
      ...
      this.appStateService.updateState({ navigationStyles, menuStyles: '',menuColor:'dark', layoutStyles: 'default' });
    }
}
...
private checkMenuElement(menuStyles: string) {
  ...
  updatemenuStyle(menuStyles: string) {
    ...
    const navStyle = document.documentElement.getAttribute('data-nav-style');
    const layoutStyle = document.documentElement.getAttribute('data-nav-layout');
